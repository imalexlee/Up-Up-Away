...
#define BACKGROUND_COLOR COLOR(0, 31, 31)
#define GRASS COLOR(0, 21, 18)
#define FOREST_GREEN COLOR(3, 9, 8)
#define WOOD_BROWN COLOR(8, 3, 1)

// Flower colors
#define FLOWER_LIGHT_RED COLOR(29, 7, 5)
#define FLOWER_DARK_RED COLOR(23, 3, 2)
#define FLOWER_LIGHT_GREEN COLOR(4, 18, 0)
#define FLOWER_DARK_GREEN COLOR(3, 14, 0)
#define FLOWER_MIDDLE COLOR(31, 29, 0)
#define FLOWER_LIGHT_ORANGE COLOR(31, 19, 2)
#define FLOWER_DARK_ORANGE COLOR(31, 10, 1)
#define FLOWER_LIGHT_PURPLE COLOR(25, 12, 30)
#define FLOWER_DARK_PURPLE COLOR(18, 4, 24)
#define FLOWER_LIGHT_PINK COLOR(30, 23, 25)
#define FLOWER_DARK_PINK COLOR(31, 15, 20)
#define FLOWER_LIGHT_BLUE COLOR(16, 20, 31)
#define FLOWER_DARK_BLUE COLOR(0, 8, 24)

// Apple colors
#define APPLE_DARK_RED COLOR(29, 2, 0)
#define APPLE_LIGHT_RED COLOR(31, 13, 10)
#define APPLE_DARK_GREEN COLOR(10, 16, 2)
#define APPLE_LIGHT_GREEN COLOR(18, 28, 6)
#define APPLE_DARK_BROWN COLOR(9, 4, 0)
#define APPLE_LIGHT_BROWN COLOR(17, 8, 1)

// Pretty colors (from lab 04)
...
// player colors
#define HAT_RED COLOR(26, 7, 9)
#define PINK_SKIN COLOR(31, 21, 14)
#define SKIN COLOR(31, 27, 18)
#define BLUE_VEST COLOR(3, 14, 23)
#define BACKPACK_GREEN COLOR(7, 19, 11)
#define BACKPACK_ORANGE COLOR(29, 16, 2)
#define SHOE_DARKGRAY COLOR(8, 8, 8)
#define SHOE_LIGHTGRAY COLOR(12, 12, 12)
